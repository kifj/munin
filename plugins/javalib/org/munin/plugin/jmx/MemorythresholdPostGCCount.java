...
public class MemorythresholdPostGCCount extends AbstractAnnotationGraphsProvider {
  ...
  protected void prepareValues() throws Exception {
    GetMemoryPoolThresholdCount collector = new GetMemoryPoolThresholdCount(getConnection());
