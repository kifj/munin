...
public class MultigraphMisc extends AbstractMultiGraphsProvider {
  ...
  protected Map<String, AbstractGraphsProvider> getProviders() {
    ...
    addWithAlias(providers, new Uptime(config), "_Uptime", PREFIX, PREFIX + ".uptime");
    ...
    addWithAlias(providers, new CompilationTimeTotal(config), "_CompilationTimeTotal", PREFIX
