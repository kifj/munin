...
public class MultigraphAll extends AbstractGraphsProvider {
  private final List<AbstractMultiGraphsProvider> providers = Arrays.asList(new MultigraphMemory(config),
      new MultigraphThreads(config), new MultigraphMisc(config));
