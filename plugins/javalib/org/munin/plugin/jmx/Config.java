...
public class Config {
  ...
  Config(final String prefix) {
    String urlParam = System.getenv(URL_PARAM);
    ip = System.getenv(IP_PARAM);
    port = System.getenv(PORT_PARAM);
    url = (urlParam != null) ? urlParam:  "service:jmx:rmi:///jndi/rmi://" + ip + ":" + port + "/jmxrmi";
    ...
    if (urlParam == null && (ip == null || port == null)) {
      String message = "The following parameters were not configured:" + (ip == null ? " ip" : "")
          + (port == null ? " port" : "") + (urlParam == null ? " or url" : "");
